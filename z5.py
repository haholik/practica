...
slovar = dict()
slovar["r1"] = {'location': '21 New Globe Walk',
                'vendor': 'Cisco',
                'model': '4451',
                'ios': '15.4',
                'ip': '10.255.0.1'}
slovar["r2"] = {'location': '21 New Globe Walk',
                'vendor': 'Cisco',
                'model': '4451',
                'ios': '15.4', 'ip': '10.255.0.2'}
slovar["sw1"] = {"location": "21 New Globe Walk",
                 "vendor": "Cisco",
                 "model": "3850",
                 "ios": "3.6.XE",
                 "ip": "10.255.0.101",
...
if par.lower() not in slovar.get("sw1").keys():
